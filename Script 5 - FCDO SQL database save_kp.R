...
organisation_table <- org_names_and_locations %>% 
  ...
  mutate(organisation_country = str_replace_all(organisation_country, "\\(the\\)", ""),  # remove (the)
         ...
         organisation_country = str_replace_all(organisation_country, "congo the democratic republic of the|drc|democratic republic of congo|congo (democratic republic)", 
                                   "democratic republic of the congo"),
         organisation_country = str_replace_all(organisation_country, "bolivia (plurinational state of)", "bolivia"),
         organisation_country = str_replace_all(organisation_country, "burma (myanmar)", "burma"),
